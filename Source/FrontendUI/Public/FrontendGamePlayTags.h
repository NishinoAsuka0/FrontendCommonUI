...
namespace FrontendGameplayTags
{
	...
	// ---- 被动技能类型标签 ----
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Skill_Passive);

	// ---- 被动技能触发条件标签 ----
	/** 受到任意伤害时触发 */
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Trigger_OnDamaged);
	/** 击杀敌人时触发 */
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Trigger_OnKill);

	// ---- 技能冷却标签（GE 激活期间授予，到期后自动移除）----
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Skill_LightAttack);
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cooldown_Skill_HeavyAttack);

	// ---- 技能输入标签 ----
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Skill_Q);
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Skill_W);
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Skill_E);
	FRONTENDUI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Skill_R);
}
